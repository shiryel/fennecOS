...
in
{
  options.fenir.livebook.enable = mkEnableOption (mdDoc "enables livebook systemd service");
  ...
  config = mkIf cfg.enable {
    ...
    systemd.user.services.livebook =
      let
        baseDir = "/home/${config.fenir.mainUser}/livebook";
      in
      {
        ...
        unitConfig = {
          ConditionUser = config.fenir.mainUser;
